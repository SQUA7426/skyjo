...
//   DiscardPile
// }
// import de.htwg.se.skyjo.model.CardImplementation.{Card, toCard}
// import de.htwg.se.skyjo.model.BoardImplementation.{Board, fillBoard, getBoardCard}
...
//       // println(s"aDisc:\n${aDisc.discPile}")
//       // println(s"aDeck:\n${aDeck.toString()}")
//       if termBoard.brd.forall(row => row.forall(_.isTurned)) then popup
//     }
//
